...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    <span class="text">Modify emploi</span>
                </div>
                <div class="bootstrap-container">
                    <div class="container">
                        <form class="row g-3" action="{{ route('emplois.update', $emploi) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Classe concernée/label>
                                <input type="text" class="form-control" name ="classe" value="{{ $emploi->classe }}">
                              </div>
                              <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Formateur/rice</label>
                                <input type="text" class="form-control"name ="teacher" value="{{ $emploi->teacher }}">
                              </div>
                              <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Image</label>
                                <input type="text" class="form-control"name ="image" value="{{ $emploi->image }}">
                              </div>
