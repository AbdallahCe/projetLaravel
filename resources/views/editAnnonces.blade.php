...
<head>
    ...
    <title>Modifier Un annonce</title> 
</head>
<body>
    <nav>
        <div class="logo-name">
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    <span class="text">Modifier L'annonce</span>
                </div>
                <div class="bootstrap-container">
                    <div class="container">
                        <form class="row g-3" action="{{ route('annonces.update', $annonce) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Nom Posteur</label>
                                <input type="text" class="form-control" name ="nomPosteur" readonly required value="{{ $annonce->nomPosteur }}">
                              </div>
                              <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Sujet</label>
                                <input type="text" class="form-control"name ="filiere" required value="{{ $annonce->filiere }}">
                              </div>                              
                              <div class="col-md-12 mt-3">
                                <div class="form-floating">
                                    <label for="floatingTextarea">Message</label>
                                    <textarea class="form-control" placeholder="Ajouter un message" name="message"  >{{$annonce->message}}</textarea>
                                </div>
                              </div>
