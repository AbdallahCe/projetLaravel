...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    <span class="text">Modify module</span>
                </div>
                <div class="bootstrap-container">
                    <div class="container">
                        <form class="row g-3" action="{{ route('modules.update', $module) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Code Module</label>
                                <input type="text" class="form-control" name ="codeModule" value="{{ $module->codeModule }}">
                              </div>
                              <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Intitulé</label>
                                <input type="text" class="form-control"name ="nomModule" value="{{ $module->nomModule }}">
                              </div>
                              <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Masse Horaire</label>
                                <input type="text" class="form-control"name ="masseHoraire" value="{{ $module->masseHoraire }}">
                              </div>
                              <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Coef</label>
                                <input type="text" class="form-control"name ="coef" value="{{ $module->coef }}">
                              </div>
