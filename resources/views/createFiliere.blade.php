...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    <span class="text">Add filiere</span>
                </div>
                <div class="bootstrap-container">
                    <div class="container">
                        <form class="row g-3" action="{{ route('filieres.store') }}" method="POST">
                            @csrf
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Code Filiere</label>
                                <input type="text" class="form-control" name ="codeFiliere" required>
                              </div>
                              <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Intitulé</label>
                                <input type="text" class="form-control"name ="nomFiliere" required>
                              </div>
